...
public class NGDSystem extends IScriptable {
    ...
    public let ModelVRAMMB: Float = 512.0;
    public let SafetyMarginMB: Float = 128.0;
    public let CooldownSeconds: Float = 90.0;
    public let EWMAAlpha: Float = 0.22;
...
public class CyberpunkNGDIntegration extends GameSystem {
    public let EnableRNNMonitoring: Bool = true;
    public let EnableNGDBridge: Bool = true;
    public let EnableLilithAttachment: Bool = true;
    public let RNNBatchSize: Int32 = 32;
    public let RNNInferenceThreads: Int32 = 4;
    public let TensorRTPrecision: String = "fp16";
    public let RNNWorkSpaceMB: Int32 = 512;
    public let EnableCUDAGraph: Bool = true;
    public let EnableDLSSFrameGen: Bool = true;
    public let MinVRAMMarginMB: Int32 = 1024;
